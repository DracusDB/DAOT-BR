...
public class ColossalSyringeItem extends Item {
    public ColossalSyringeItem(Settings settings) {
        super(settings);
    }
    ...
    public void appendTooltip (ItemStack itemStack, TooltipContext context, List<Text> tooltip, TooltipType type) {
        tooltip.add((Text.literal("The God of Destruction").formatted(Formatting.YELLOW, Formatting.ITALIC)));
    }
        ...
        if (!world.isClient() && user instanceof ServerPlayerEntity serverPlayer) {
            ...
            if (server != null) {
                ...
                List<String> commands = List.of(
                        ...
                        "daot shifter set " + playerName + " colossal",
                        "team join Colossal " + playerName,
                ...
                for (ServerPlayerEntity p : server.getPlayerManager().getPlayerList()) {
                    p.sendMessage(
                            Text.literal(playerName + " has claimed the power of the Colossal Titan!")
